...
class TestRepository(database_mock):
    ...
    def test_query_value(self):
        with self.mock_db_config:
            ...
            self.assertEqual(RepositoryCommands.send_request("select id, username from korisnik_test where email = luka.ciric@yahoo.com;"), ("REJECTED", 3000, "Not valid query for reading data: 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '@yahoo.com' at line 1"))